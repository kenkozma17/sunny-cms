<div class="grid grid-cols-12 md:gap-[3rem] gap-[1.5rem] relative md:my-[4.5rem] my-[2rem]">
    <div class="md:col-span-6 col-span-12 md:order-first order-last">
        <h2 class="md:leading-[60px] text-primary-gray md:mb-[1rem] mb-[.5rem]">{{ $set['title'] }}</h2>
    ...
    <div class="md:col-span-6 col-span-12 md:order-last order-first">
